...
//FT81XMania: TFTLCDCyg
  ...
  //FT81XMANIA TEAM (RndMnkIII) m̩todo loadSdFat para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
  byte loadSdFat(File& archivo, void (*progress)(long, long) = NULL);

  void safeload(const char *filename);

  //FT81XMANIA TEAM (RndMnkIII) m̩todo safeloadSdFat para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
